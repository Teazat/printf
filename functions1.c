...
/**
* custom_print_hexadecimal - Custom print
...
/**
* custom_print_hexa_upper - Custom print an unsigned number in upper hexadecimal notation
* @custom_args: List of arguments
* @custom_buffer: Buffer array to handle print
* @custom_flags: Calculate active flags
* @custom_width: Get width
...
* Return: Number of characters printed
*/
int custom_print_hexa(va_list custom_args, char custom_map_to[], char custom_buffer[],
int custom_flags, char custom_flag_ch, int custom_width, int custom_precision, int custom_size)
{
int custom_index = CUSTOM_BUFF_SIZE - 2;
unsigned long int custom_num = va_arg(custom_args, unsigned long int);
unsigned long int custom_init_num = custom_num;
